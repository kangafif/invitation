                    ...
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <div>
                            <a href="index" class="d-inline-block auth-logo">
                                <img src="{{ URL::asset('build/images/logo-keemasan.png')}}" alt="" height="20">
                            </a>
                        </div>
                        <p class="mt-3 fs-15 fw-medium">Bersama Menuju Masa KeEmasan45</p>
                    </div>
                </div>
            </div> --}}
            <!-- end row -->
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                <h5 class="text-primary">
                                    <img src="{{ URL::asset('build/images/logo-keemasan.png')}}" alt="" height="150">
                                </h5>
                            </div>
                            <div class="p-2 mt-4">
                                <form action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('email') is-invalid @enderror" id="username" name="email" placeholder="Enter email" required>
                                        @error('email')
