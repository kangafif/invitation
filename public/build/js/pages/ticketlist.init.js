...
//         ticketsList.add({
//             id: '<a href="javascript:void(0);" onclick="ViewTickets(this)" data-id="' + element.id + '" class="fw-medium link-primary ticket-id">' + element.id + "</a>",
...
//         refreshCallbacks();
//     });
//     ticketsList.remove("id", `<a href="javascript:void(0);" onclick="ViewTickets(this)" data-id="001" class="fw-medium link-primary">001</a>`);
// }
...
function ViewTickets(data) {
    ...
    var item = ticketsList.get('id', '<a href="javascript:void(0);" onclick="ViewTickets(this)" data-id="' + d_id + '" class="fw-medium link-primary ticket-id">' + d_id + '</a>');
