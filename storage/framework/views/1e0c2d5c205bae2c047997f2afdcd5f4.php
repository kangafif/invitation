                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                <h5 class="text-primary">
                                    <img src="<?php echo e(URL::asset('build/images/logo-keemasan.png')); ?>" alt="" height="150">
                                </h5>
                            </div>
                            <div class="p-2 mt-4">
...
unset($__errorArgs, $__bag); ?>" id="username" name="email" placeholder="Enter email" required>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\undangan\resources\views/auth/login.blade.php ENDPATH**/ ?>