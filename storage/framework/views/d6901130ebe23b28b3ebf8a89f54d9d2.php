                                    ...
                                    <div class="col-12">
                                        <div class="card card-height-100">
                                            <div class="card-body">
                                                    ...
                                                    <div class="p-4 rounded-3 mb-3" style="background: url('<?php echo e(asset('build/images/bg-ungu-emas.jpg')); ?>') no-repeat center center; background-size: cover;">
                                                        <div class="d-flex">
                                                            <div class="flex-grow-1 text-light text-center">
                                                                <h5 class="text-warning mb-2">GRAND LAUNCHING INVITATION</h5>
                                                ...
                                                <button class="btn btn-success w-100 mt-3" type="submit"><i class="ri-whatsapp-line me-1 align-middle"></i> Share</button>
                                                <!-- end card form elem -->
                                            </div>
                                        </div>
                                        <!-- end card -->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\undangan\resources\views/users.blade.php ENDPATH**/ ?>